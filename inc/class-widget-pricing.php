 ...
 * @see WP_Widget
 */
class Checathlon_Plus_Widget_Pricing extends WP_Widget {
	...
	public function __construct() {
		$widget_ops = array(
			...
			'description'                 => esc_html__( 'Info about your services or pricing.', 'checathlon-plus' ),
			'customize_selective_refresh' => true,
		);
		$control_ops = array( 'width' => 400, 'height' => 350 );
		parent::__construct( 'checathlon_widget_pricing', esc_html__( 'Service and Pricing Widget (Checathlon)', 'checathlon-plus' ), $widget_ops, $control_ops );
	}
	...
	public function form( $instance ) {
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'icon' ); ?>"><?php esc_html_e( 'Icon:', 'checathlon-plus' ); ?></label>
			<select class="widefat" id="<?php echo $this->get_field_id( 'icon' ); ?>" name="<?php echo $this->get_field_name( 'icon' ); ?>">
				<option value="0"><?php esc_html_e( 'Select icon', 'checathlon-plus' ); ?></option>
				<?php
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'title' ); ?>"><?php esc_html_e( 'Title:', 'checathlon-plus' ); ?></label>
			<input class="widefat" id="<?php echo $this->get_field_id( 'title' ); ?>" name="<?php echo $this->get_field_name( 'title' ); ?>" type="text" value="<?php echo esc_attr( $title ); ?>" />
		</p>

		<p>
			<label for="<?php echo $this->get_field_id( 'highlight_title' ); ?>"><?php esc_html_e( 'Hightlight Title (use for the most important service or price):', 'checathlon-plus' ); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'text' ); ?>"><?php esc_html_e( 'Content:', 'checathlon-plus' ); ?></label>
			<textarea class="widefat" rows="16" cols="20" id="<?php echo $this->get_field_id( 'text' ); ?>" name="<?php echo $this->get_field_name( 'text' ); ?>"><?php echo esc_textarea( $instance['text'] ); ?></textarea>
		</p>

		<p>
			<input id="<?php echo $this->get_field_id( 'filter' ); ?>" name="<?php echo $this->get_field_name( 'filter' ); ?>" type="checkbox"<?php checked( $filter ); ?> />&nbsp;<label for="<?php echo $this->get_field_id( 'filter' ); ?>"><?php esc_html_e( 'Automatically add paragraphs', 'checathlon-plus' ); ?></label>
		</p>

		<p>
			<label for="<?php echo $this->get_field_id( 'price' ); ?>"><?php esc_html_e( 'Price:', 'checathlon-plus' ); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'link_text' ); ?>"><?php esc_html_e( 'Link text:', 'checathlon-plus' ); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'link_url' ); ?>"><?php esc_html_e( 'Link URL:', 'checathlon-plus' ); ?></label>
 ...
 * @since 1.0.0
*/
function checathlon_plus_register_widgets() {
	register_widget( 'Checathlon_Plus_Widget_Pricing' );
}
add_action( 'widgets_init', 'checathlon_plus_register_widgets' );
