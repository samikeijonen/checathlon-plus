 ...
 **/
function checathlon_plus_fonts_format_choices( $font_groups ) {
 ...
 **/
function checathlon_plus_get_font_weight( $font_name, $return_array = false ) {
	// Get all fonts data.
	...
	if ( isset( $fonts[$font_name]['weight'] ) ) {
		...
		$allowed_weight = checathlon_plus_fonts_allowed_weight();
 ...
 **/
function checathlon_plus_get_font_family( $font_name ) {
	$fonts = checathlon_plus_fonts();
 ...
 * Get Font Subsets.
 **/
function checathlon_plus_get_font_subsets( $font_name ) {
	$fonts = checathlon_plus_fonts();
 ...
 **/
function checathlon_plus_fonts_remove_websafe( $font ) {
 ...
 * Font Weight Options.
 **/
function checathlon_plus_fonts_font_weight_choices() {
	$choices = array(
		'lighter' => 'lighter',
		'normal'  => 'normal',
		'bold'    => 'bold',
	...
	return apply_filters( 'checathlon_plus_fonts_font_weight_choices', $choices );
}
