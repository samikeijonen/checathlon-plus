 ...
 */
	...
	$wp_customize->add_section(
		...
		array(
			'title'           => esc_html__( 'Before Footer Widgets Settings', 'checathlon-plus' ),
			'description'     => esc_html__( 'In this section you can add title and icons in before footer widget area.', 'checathlon-plus' ),
			'priority'        => 20,
			'panel'           => 'theme',
	...
	$wp_customize->add_control(
		'before_footer_area_title',
		array(
			'label'    => esc_html__( 'Before footer area title', 'checathlon-plus' ),
	...
	foreach ( $icons_args as $setting => $default ) {
		...
		$setting,
			array(
				...
				'label'   => sprintf( esc_html__( 'Icon before footer widget area %s', 'checathlon-plus' ), $k ),
				'type'    => 'select',
				'choices' => $icons,
				'section' => 'before-footer-widget',
			)
